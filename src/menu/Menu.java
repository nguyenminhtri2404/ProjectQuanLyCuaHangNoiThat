...
public class Menu extends JPanel {
    ...
    private void init() {
        ...
        addTitle("FEATURES");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.INSERT_CHART, "QUẢN LÝ NHẬP", "Nhà cung cấp", "Danh mục", "Sản phẩm","Khuyến mãi", "Khách hàng","Phiếu nhập","Hóa đơn"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.COLLECTIONS, "QUẢN LÝ XUẤT","Tra cứu"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PEOPLE, "QUẢN LÝ NHÂN VIÊN"));
    ...
    public void addTitle(String title) {
        ...
        label.setForeground(new Color(227, 228, 230));
        panelMenu.add(label);
    }
